...
namespace WebApplication3.Controllers
{
    public class UsersController : Controller
    {
        ...
        {
            ViewData["Title"] = _localizer["Create_Header"];
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,FirstName,LastName,Age,Email,CreatedAt,UpdatedAt,Status")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
